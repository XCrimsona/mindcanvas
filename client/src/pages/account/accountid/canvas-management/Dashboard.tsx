...
const Dashboard = ({ params }: { params: any }) => {
  ...
  const fetchMoreData = async () => {
    const response = await fetch(
      // `http://localhost:3000/api/account/${param.accountid}/dashboard/canvas-management`
      `http://localhost:3000/api/account/${param.accountid}/canvas-management`
    );
  ...
  const updateWorkspace = async (e: any, workspaceId: string) => {
    try {
      ...
      const response = await fetch(
        ...
        `http://localhost:3000/api/account/${params.accountid}/canvas-management`,
        {
          method: "PATCH",
          ...
          <Div className={management["workspace-sheets"]}>
                ...
                return (
                  ...
                  >
                    <form className={workspacesheetWrapper["workspace-sheet"]}>
                      ...
                      >
                        <RouteLink
                          // href={`http://localhost:3000/account/${params.accountid}/dashboard/canvas-management/${workspace._id}`}
                          href={`http://localhost:3000/account/${params.accountid}/canvas-management/${workspace._id}`}
                          className={
            ...
            {displayNewWorkspace && (
              <Div className={workspacesheetWrapper["workspace-sheet-wrapper"]}>
                <form
                  className={
                    workspacesheetWrapper["workspace-sheet-temp-field"]
                  }
                ...
                >
                  ...
                  >
                    <InputSubmit
                      ...
                      className={
                        workspacesheetWrapper["create-workspace-sheet"]
                      }
                    />
                  </Div>
                </form>
